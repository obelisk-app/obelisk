...
That split lets us ship Discord-grade UX today (threads, reactions, search, moderation — hard to do purely on Nostr right now) while giving you a real, portable identity. Over time the pendulum swings toward the Nostr side; see [the future guide](/guides/future-nostr-relays).
...
- **Web of Trust** — your server's "who is trustworthy" list is derived from Nostr follow-graphs. See the [WoT guide](/guides/web-of-trust).
...
- [The future is relay-based groups](/guides/future-nostr-relays)
