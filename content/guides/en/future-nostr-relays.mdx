...
- A **moderation layer** — clients enforce local rules on top of whatever the relay permits: muting noisy senders, hiding low-trust posts ([WoT](/guides/web-of-trust)), promoting Nostr NIP-05 verified users.
...
- [How Obelisk works today](/guides/how-obelisk-works)
- [Web of Trust, explained](/guides/web-of-trust)
