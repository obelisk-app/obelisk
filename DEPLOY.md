...
# Only used to decrypt legacy server-stored NWC connection strings during
# the one-time client-side wallet migration (see /api/wallet/legacy-export).
# Once all users have migrated, this can be removed.
